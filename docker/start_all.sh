...
# --- T4: MAVROS2 ---
# Collegamento all'uscita UDP di MAVProxy, NON alla porta TCP SERIAL1 del SITL.
# Il TCP diretto era stato provato per aggirare un crash di MAVROS, ma su
# SERIAL1 ArduPilot non emette gli stream di posizione: /mavros/state riceveva
# l'heartbeat mentre local_position/pose e global_position/rel_alt restavano
# muti. mission_node non vedeva mai la posizione, la distanza dal waypoint
# risultava infinita e il drone non si muoveva. MAVProxy invece richiede gli
# stream su SERIAL0 e li ridistribuisce.
